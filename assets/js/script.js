...
$(document).click(function(click) {
	...
	if(!target.hasClass("items") && !target.hasClass("optionButton")) {
		hideOptionsMenu();
	}
...
function showOptionsMenu(button) {
	...
	var ellementOffset = $(button).offset().top; //Distance from top of document

	var top = ellementOffset - scrollTop;
...
function Audio() {
	...
	this.audio.addEventListener("canplay", function() {
		// 'this' reffers to the object that the event was called on.
